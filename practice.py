...
def find_unique_common_items(items1, items2):
    ...
    **IMPORTANT**: you may not use `'if ___ in ___``
    ...
    different data types:
        ...
        [2]
    """
    a_set = set(items1).intersection(set(items2))
    return a_set
...
def top_chars(phrase):
    ...
    #dictionary comprehension is very useful here
    word = [key for key, value in dict.items() if value == max(dict.values())]
    words = sorted(word)
